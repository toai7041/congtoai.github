   ...
   <div class="ContentStyle-ForSite"> 
    <header class="entry-header">        
           <div class="BlogMeta-Strip">
			 <?php if( get_theme_mod( 'electro_mart_hide_postdate_fromsingle' ) == '') { ?> 
                  <div class="post-date"> <i class="far fa-clock"></i>  <?php echo esc_html( get_the_date() ); ?></div><!-- post-date --> 
                <?php } ?> 
                
                <?php if( get_theme_mod( 'electro_mart_hide_postcats_fromsingle' ) == '') { ?> 
    ...
    <footer class="entry-meta">
      <?php edit_post_link( __( 'Edit', 'electro-mart' ), '<span class="edit-link">', '</span>' ); ?>
    </footer><!-- .entry-meta -->
