...
function supermart_ecommerce_scripts() {
	...
	$supermart_ecommerce_site_title_fontsize = get_theme_mod('supermart_ecommerce_site_title_fontsize');
	...
	$custom_css = '
		...
		.logo h1.site-title, .logo p.site-title {
			font-size: '.esc_attr($supermart_ecommerce_site_title_fontsize).'px;
		}
	';
